 ...
 * 
 * In general the Main will create a new UI object and model object, since the
 * project works in MVC, we will create a Presenter that will observe both of
 * these objects for needed actions.
 * 
 * Then starts the UI in a different thread. Have Fun !
 * 
